...
<table><tr><td><input type="text" name="sname" /></td><td><input type="submit" value="search" /></td></tr></table>
</form>
...
<%
  ...
  ResultSet rs=obj1.FetchServiceBySname(sname);
   
%>
<form action="UpdateServiceServlet" method="post">
<%if(rs.next()){ %>
<table>
    <tr><td>stype</td><td><input type="text" name="stype" value="<%=rs.getString(1) %>"/></td></tr>
    <tr><td>sname</td><td><input type="text" name="sname" value="<%=rs.getString(2) %>" readonly=readonly/></td></tr>
     <tr><td>price</td><td><input type="text" name="price" value="<%=rs.getString(3) %>" /></td></tr>
    
    <tr><td>detail</td><td><input type="text" name="detail"  value="<%=rs.getString(4) %>" /></td></tr>
