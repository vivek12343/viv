...
<div id="wrap">
  <div id="header">
    <h1 id="logo">IT ASSETS COMMUNITY </h1> <h1> &nbsp;<a href ="index.html" style=float:right;color:black; >HOME</a>
   </h1>
    <h2 id="slogan">Discussion Forum and &ndash; Q &amp; A</h2>
    <div id="menu">
      <ul>
...
try
{
	...
	String sql="select * from question where email=? order by date desc";
	ResultSet rs=ProjectDao.myQuestion(sql, email);
