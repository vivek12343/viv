...
<body><center>
<h1 style="background-image: url('itasset21.png'); color:black;">IT ASSETS &nbsp;<a href ="index.html" style=float:right;color:black;>HOME</a></h1></h1>
</center>
...
<div class="limiter">
   ...
   <form action="AgentLoginServlet" method="post">
					...
					<div class="wrap-input100 validate-input m-b-10" data-validate = "email is required">
						<input class="input100" type="email" name="email" placeholder="Agentname">
