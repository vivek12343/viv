...
<meta charset="utf-8">
    ...
    <title> IT ASSETS &nbsp;<a href ="index.html" style=float:right;color:black;>HOME</a></h1></title>
...
&nbsp;<a href ="index.jsp" style=float:right;color:black;>HOME</a></h1>
...
<tr>
<td>enter name </td>
      <td>  <input type="text" name="agent_name" size="30" placeholder="name plz..."/>
</td>
</tr>
<tr>
<td>enter pwd </td>
      <td>  <input type="password" name="pwd" size="30" placeholder="password  plz..."/>
</td>
</tr>
<tr>
<td>enter  highest qualification</td>
<td> <input type="text" name="edu" size="30" />
</td></tr>
<tr>
<td>enter  email</td>
<td> <input type="email" name="email" size="30" required placeholder="abc@gmail.com"/>
</td></tr>
<tr><td>enter  contact</td>

<td> <input type="text" name="contact" size="30" required placeholder="98********"/>
</td></tr>
<tr>
<td>enter specialization with skills</td>
<td> <textarea rows="10" cols="10" name="skills" class="a"></textarea>
...
<td> <input type="number" name="exp" size="30" required placeholder="98********"/>
</td>

</tr>
<tr>
<td>ENTER YOUR LATTITUDE</td>
<td> <input type="text" name="longitude" size="50" hieght:"200px;" required placeholder="55.5815E"/>
</td></tr>
<!**********************************************************************************************>
<tr>
<td>ENTER YOUR LONGITUDE</td>
<td> <input type="text" name="lattitude" size="50" hieght:"200px;" required placeholder="25.5415N"/>
</td></tr>
<tr>
				<td>Choose Image:</td>
				<td><input type="file" name="pic" size="100"
...
<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 <input type="submit" value="register" size="20"  style=background-color:#6495ed;width:200px;/>
</form>
</center>
